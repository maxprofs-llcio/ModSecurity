...
class RuleWithActions : public Rule {
 public:
    ...
    inline std::shared_ptr<actions::LogData> getLogDataAction() { return m_logData; }
    ...
    inline std::shared_ptr<actions::Msg> getMessageAction() { return m_msg; }
